...
(function(global , factory){
    ...
    function UploadImage(selector , opt){
        ...
        this._image                 = G.isObj(opt.image) ? opt.image : this._default.image;
    ...
    UploadImage.prototype = {
        ...
        _initStaticArgs: function(){
            ...
            // 处理图片
            this._image.delete_unfocus = G.isValid(this._image.delete_unfocus) ? this._image.delete_unfocus : this._pluginUrl + '/image/delete_unfocus.png';
        } ,
        ...
        templateOne: function(assign){
            ...
            html += "			<div class='close'><img src='" + this._image.delete_unfocus + "' data-focus='" + this._image.delete_unfocus + "' data-unfocus='" + this._pluginUrl + "image/delete_unfocus.png' class='image' /></div>	";
