                    ...
                    <div class="data">
                        <div class="run-title">
                            ...
                            <div class="right">
                                ...
                                <button type="button" class="run-button run-button-blue" @click="location('/project/add' , {mode: 'add'} , '_blank')">新增 <i class="run-iconfont run-iconfont-add"></i></button>
                            </div>
                        </div>
                        <table class="line-tb">
                            <thead>
                            ...
                            <tr v-for="(v,k) in listData" :key="v.id" @click="selectEvent(v.id)">
                                ...
                                <td>{{ v.create_time }}</td>
                                <td>
                                    <button type="button" class="run-button run-button-blue" @click.stop="location('/project/edit' , {id: v.id , mode: 'edit'})">编辑 <i class="run-iconfont run-iconfont-edit"></i></button>
